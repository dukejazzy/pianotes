export default function DisplayTable() {
  ...
  <div className="container px-4 mx-auto">
    ...
    <p className="mb-20 text-lg text-gray-400 text-center font-medium leading-normal md:max-w-lg mx-auto">
      Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse
      varius enim in eros elemen tum.
    </p>
    <div className="relative overflow-hidden border border-gray-800 rounded-4xl md:max-w-3xl mx-auto">
      <img
        className="absolute top-0 left-0"
        src="flaro-assets/images/pricing/gradient2.svg"
        alt=""
      />
      <div className="flex flex-wrap divide-y md:divide-x md:divide-y-0 divide-gray-800">
        <div className="w-full md:w-1/2">
          <div className="px-11 pt-10 pb-12 bg-gray-900">
            <svg
              className="mb-9"
              width={48}
              height={48}
            ...
            <p className="mb-3 text-gray-500 font-semibold leading-normal">
              On your machine
            </p>
            <h3 className="mb-11 text-3xl text-white font-bold leading-snug">
              Flaro can run on your PC
            </h3>
            <ul className="mb-11">
              <li className="mb-4 flex items-center">
                ...
                <p className="text-gray-100 font-semibold leading-normal">
                  3 Team Members
                </p>
              </li>
              <li className="mb-4 flex items-center">
        ...
        <div className="w-full md:w-1/2">
          <div className="px-11 pt-10 pb-12 bg-gray-900">
            ...
            <div className="md:inline-block">
              <button
                className="py-4 px-11 w-full font-semibold rounded-xl shadow-6xl focus:ring focus:ring-gray-300 bg-white hover:bg-gray-100 transition ease-in-out duration-200"
                type="button"
              >
                Start on Cloud
              </button>
